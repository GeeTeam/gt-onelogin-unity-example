...
public class OneLoginBean {
    ...
    public boolean isBlockReturnKey() {
        return blockReturnKey;
    }

    public void setBlockReturnKey(boolean blockReturnKey) {
        this.blockReturnKey = blockReturnKey;
    }

    public boolean isBlockReturnBtn() {
        return blockReturnBtn;
    }

    public void setBlockReturnBtn(boolean blockReturnBtn) {
        this.blockReturnBtn = blockReturnBtn;
    }

    public int getPrivacyLayoutGravity() {
        return privacyLayoutGravity;
    }

    public void setPrivacyLayoutGravity(int privacyLayoutGravity) {
        this.privacyLayoutGravity = privacyLayoutGravity;
    }
