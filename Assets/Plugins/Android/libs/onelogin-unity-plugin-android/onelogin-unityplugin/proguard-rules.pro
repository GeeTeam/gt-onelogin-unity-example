...
-keep class com.geetest.onelogin.callback.** {*;}
-keep class com.geetest.onelogin.bean.** {*;}
-keep class com.geetest.onelogin.OneLoginManager* {*;}

-keeppackagenames com.geetest.onelogin.util
-keeppackagenames com.geetest.onelogin.wrapper
